...
onmessage = function(e) {
    ...
    // SMOOTHING: Using (7,7) instead of (5,5) to remove skin "dots"
    cv.GaussianBlur(gray, blurred, new cv.Size(7, 7), 0);
    
    // FILTER: Laplacian for clean edges
    cv.Laplacian(blurred, edges, cv.CV_8U, 5);
    
    // AUTO-THRESHOLD: Otsu ignores minor noise and focuses on strong lines
